...
/**
 * Retrieves clan river race log by clanTag.
...
async function getClanRiverRaceLog(clanTag, limit) {
    ...
    if (clanTag.startsWith('#')) {
        ...
        var fetchUrl = '';
        if (!limit) {
            fetchUrl = `https://api.clashroyale.com/v1/clans/${clanTagConverString}/riverracelog`;
        } else {
            fetchUrl = `https://api.clashroyale.com/v1/clans/${clanTagConverString}/riverracelog?limit=${limit}`;
        }
...
module.exports = { getClanRiverRaceLog };  